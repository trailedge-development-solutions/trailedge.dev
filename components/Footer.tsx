...
export default function Footer() {
  return (
    <footer className="w-screen p-4 sm:p-6">
      <div className="mx-auto max-w-screen-xl">
	  <div className="md:flex md:justify-between">
	      <div className="mb-6 md:mb-0">
		  <a href="#" className="flex items-center">
		      <img src="/images/logo-full.png" className="mr-3 h-8" alt="Trailedge" />
		  </a>
	      </div>
	  ...
	  <div className="sm:flex sm:items-center sm:justify-between">
	      <span className="text-sm text-gray-500 sm:text-center"><a href="#" className="hover:underline">Trailedge Development Solutions</a> - Richmond, VA
	      </span>
